...
#include "ssid.h"
#include "qos-utils.h"
#include "ns3/busy-tone-phy.h"/////liang
namespace ns3 {
...
public:
   ...
   */
  //virtual void SetBusytonePhy (Ptr<BusytonePhy> btphy) = 0;////liang
  
  //virtual Ptr<BusytonePhy> GetBusytonePhy (void) const = 0;
  virtual void SetWifiPhy (Ptr<WifiPhy> phy) = 0;
  virtual void SetWifiPhy (Ptr<WifiPhy> phy,Ptr<BusytonePhy> btphy) = 0;
  /**
