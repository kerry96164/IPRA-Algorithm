...
public:
  ...
  bool Ispowercontrol (void) const;

  bool IsPositionPacket (void) const; // Jonathan
  /**
...
private:
  ...
  uint8_t m_ifgreaterthanzero;
  uint16_t m_duration; ///< duration
  uint16_t m_toleratepower;
  uint16_t m_txpower;
  Vector m_position; ///< position of the node // Jonathan
