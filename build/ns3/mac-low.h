...
public:
  ...
  void NotifyToleranceInterferencemac(double ToleranceInterference,WifiTxVector tx_vector,Time duration,WifiMacHeader hdr);/////liang
  void Sendpowercontrolpacket(uint16_t tolerancepower,WifiTxVector tx_vector,Time duration,WifiMacHeader hdr);
  void NotifyBusytoneTxStart(Time rxDuration);////liang
  void NotifyToleranceInterference(double ToleranceInterference);/////liang
  void NotifyRxStart(Time duration);///////liang
  void NotifyRxEndOk(void);
  void NotifyRxEndError(void);
  void NotifyTxStart(Time duration);
  void NotifyMaybeCcaBusyStart(Time duration);
  void NotifyRxEndErrorBecauseWrongAddress();
    double m_txpower;
  /**
  ...
  void SetBusytonePhy (const Ptr<BusytonePhy> btphy);///////liang
  
  Ptr<BusytonePhy> GetBusytonePhy (void) const;   ////liang
...
////liang
  double Gettxpowerfrombusytonephy();
  bool BusytoneIsIdle();
  void ChannelBusy();
  double FindTxpower(const WifiMacHeader* hdr);
...
private:
  ...
  Ptr<BusytonePhy> m_busytonephy;///////liang
