...
public:
  ...
  */
  ...
  //void SetBusytonePhy (Ptr<BusytonePhy> btphy);//////liang
  
  //Ptr<BusytonePhy> GetBusytonePhy(void) const;/////liang
  void SetWifiPhy (const Ptr<WifiPhy> phy);
  void SetWifiPhy (const Ptr<WifiPhy> phy,const Ptr<BusytonePhy> btphy);
  /**
  ...
  Ptr<DcaTxop> getdca(void)const;////////steve getdca
