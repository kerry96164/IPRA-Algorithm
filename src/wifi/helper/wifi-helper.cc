...
void /////liang
WifiHelper::SetBusytonePhyHelper(BusytonePhyHelper &busytonehelper)
{
	m_busytonehelper = busytonehelper;
}
  ...
  for (NodeContainer::Iterator i = first; i != last; ++i)
    {
      ...
      Ptr<WifiMac> mac = macHelper.Create ();///////a new MAC object
	  ...
	  device->SetBusytonePhy (btphy);/////liang
