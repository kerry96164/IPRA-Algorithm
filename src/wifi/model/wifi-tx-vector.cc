...
///liang
void
WifiTxVector::AddTxPowerNowIntoVector(double txpower)
{//std::cout<<"addtxpower power = "<<txpower<<" "<<Simulator::Now().GetSeconds()<<std::endl;
	m_txpower = txpower;
}
///liang
double
WifiTxVector::GetTxPowerFromVector(void)
{//std::cout<<"gettxpower power = "<<m_txpower<<" "<<Simulator::Now().GetSeconds()<<std::endl;
	return m_txpower;
}
