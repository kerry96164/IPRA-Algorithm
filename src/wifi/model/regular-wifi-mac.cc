...
void
RegularWifiMac::SetWifiPhy (const Ptr<WifiPhy> phy,const Ptr<BusytonePhy> btphy)
{
...
/*void SetBusytonePhy (Ptr<BusytonePhy> btphy)
{
//NS_LOG_FUNCTION (this << btphy);
  m_busytonephy = btphy;
  m_low->SetBusytonePhy (btphy);
}/////liang*/
...
RegularWifiMac::GetBusytonePhy (void) const
{
  NS_LOG_FUNCTION (this);
