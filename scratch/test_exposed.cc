...
double run(double simulationTime,double space)
{
  ...
  cbrApps.Add(gencbr(nodes.Get (0),nodes.Get (1),NodeInterface.GetAddress (0),simulationTime,a[i],0.1));
  cbrApps.Add(gencbr(nodes.Get (3),nodes.Get (2),NodeInterface.GetAddress (3),simulationTime,a[i],0.2));
  cbrApps.Add(gencbr(nodes.Get (4),nodes.Get (5),NodeInterface.GetAddress (4),simulationTime,a[i],0.3));
  cbrApps.Add(gencbr(nodes.Get (7),nodes.Get (6),NodeInterface.GetAddress (7),simulationTime,a[i],0.4));
  cbrApps.Add(gencbr(nodes.Get (8),nodes.Get (9),NodeInterface.GetAddress (8),simulationTime,a[i],0.5));
  cbrApps.Add(gencbr(nodes.Get (11),nodes.Get (10),NodeInterface.GetAddress (11),simulationTime,a[i],0.6));
  cbrApps.Add(gencbr(nodes.Get (12),nodes.Get (13),NodeInterface.GetAddress (12),simulationTime,a[i],0.7));
  cbrApps.Add(gencbr(nodes.Get (15),nodes.Get (14),NodeInterface.GetAddress (15),simulationTime,a[i],0.8));
