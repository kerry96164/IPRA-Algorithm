...
int c ,d;
  ...
  for(int i=0;i<8;i++)
 {
  ...
  cbrApps.Add(gencbr(nodes.Get (1),nodes.Get (0),NodeInterface.GetAddress (1),simulationTime,a[0],0.1));
  cbrApps.Add(gencbr(nodes.Get (2),nodes.Get (3),NodeInterface.GetAddress (2),simulationTime,a[1],0.2));
  cbrApps.Add(gencbr(nodes.Get (5),nodes.Get (4),NodeInterface.GetAddress (5),simulationTime,a[2],0.3));
  cbrApps.Add(gencbr(nodes.Get (6),nodes.Get (7),NodeInterface.GetAddress (6),simulationTime,a[3],0.4));
  cbrApps.Add(gencbr(nodes.Get (9),nodes.Get (8),NodeInterface.GetAddress (9),simulationTime,a[4],0.5));
  cbrApps.Add(gencbr(nodes.Get (10),nodes.Get (11),NodeInterface.GetAddress (10),simulationTime,a[5],0.6));
  cbrApps.Add(gencbr(nodes.Get (13),nodes.Get (12),NodeInterface.GetAddress (13),simulationTime,a[6],0.7));
  cbrApps.Add(gencbr(nodes.Get (14),nodes.Get (15),NodeInterface.GetAddress (14),simulationTime,a[7],0.8));
